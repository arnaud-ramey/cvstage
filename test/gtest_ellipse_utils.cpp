/*!
  \file        gtest_cvstage_plugins.cpp
...
void test_three_pts2ellipse(Pt2 center, Pt2 end1, Pt2 end2,
  ...
  cvstage_plugins::Ellipse e = cvstage_plugins::three_pts2ellipse(center, end1, end2);
...
void test_ellipse_axes(Pt2 center, double w, double h, double theta_deg,
  ...
  cvstage_plugins::Ellipse e(center, cv::Size2f(w, h), theta_deg);
  Pt2 long1, long2, short1, short2;
  cvstage_plugins::ellipse_axes(e, long1, long2, short1, short2);
