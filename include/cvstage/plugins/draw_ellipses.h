...
#ifndef cvstage_PLUGINS_ELLISPES_H
#define cvstage_PLUGINS_ELLISPES_H

#include "cvstage/cvstage.h"
// ellipse
//#include "cvstage/ellipse_utils.h"
...
void draw_ellipse(MiniStage & ms,
  ...
  ellipse_axes(e, long1, long2, short1, short2);
  ...
  cv::ellipse(ms.get_viz(),
              three_pts2ellipse(px_center, px_long1, px_short1),
              color, thickness, lineType);
}

} // end namespace cvstage_plugins

#endif // cvstage_PLUGINS_ELLISPES_H
